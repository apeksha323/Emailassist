        ...
        >
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-black text-white hover:bg-gray-800 py-3 transition-all duration-300 hover:scale-105"
            >
              Generate Reply
            ...
            {(isTyping || showResponse) && (
              <motion.div
                ...
                className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 text-left border border-blue-200"
              >
