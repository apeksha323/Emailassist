        ...
        >
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#5f77f8] to-violet-600 hover:from-[#4c63d2] hover:to-violet-700 text-white py-3 transition-all duration-300 hover:scale-105"
            >
              Generate Reply
              ...
              >
                ...
                {isTyping ? (
                  <motion.div className="flex items-center space-x-1">
                    ...
                    >
                      <div className="w-2 h-2 bg-[#5f77f8] rounded-full" />
                      <div className="w-2 h-2 bg-[#5f77f8] rounded-full" />
                      <div className="w-2 h-2 bg-[#5f77f8] rounded-full" />
                    </motion.div>
                  </motion.div>
